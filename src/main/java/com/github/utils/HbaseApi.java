...
/*        createNamespace("aa");
      ...
      //   dropTable("mytable");
        ...
        addRowData("staffe", "row1", "cf1", "name", "zhangsan");
        addRowData("staffe", "row2", "cf1", "name", "lisi");
        addRowData("staffe", "row3", "cf1", "name", "wangwu");
        getAllRows("staffe");
        addRowData("staffe", "row1", "cf1", "teacher", "teacher01");
        addRowData("staffe", "row2", "cf1", "teacher", "teacher02");
        addRowData("staffe", "row3", "cf1", "teacher", "teacher03");

         getRow("bulktest", "1");
        //  getRowQualifier("staffe", "1001", "cf1", "name");

     //   createTable("mytable", "mycf", "cf2");
        addRowData("mytable", "row3", "mycf", "name", "JACK");
        addRowData("mytable", "row5", "mycf", "name", "JACK");
        addRowData("mytable", "row7", "mycf", "name", "JACK");
